# User guide Outlet Manager

Menangani operasional outlet dan otorisasi. Stok awal tidak dapat diedit. Ringkasan, Produk, Pembelian, Laporan, dan Pengaturan tidak tersedia pada akses bawaan.

Cabang: Cabang akun. Pemegang otorisasi: ya. Edit stok awal: tidak.
...
![Outlet Manager — Kasir dan tutup kasir](../fix-verification-2026-09-06/screenshots/role-outlet_manager-kasir.png)
...
![Outlet Manager — Transaksi](../fix-verification-2026-09-06/screenshots/role-outlet_manager-transaksi.png)
...
![Outlet Manager — Stok / Gudang](../fix-verification-2026-09-06/screenshots/role-outlet_manager-gudang.png)
...
![Outlet Manager — Pengeluaran](../fix-verification-2026-09-06/screenshots/role-outlet_manager-pengeluaran.png)
...
![Outlet Manager — Membership dan deposit](../fix-verification-2026-09-06/screenshots/role-outlet_manager-member.png)
