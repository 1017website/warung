# User guide Ops Admin

Mengelola operasional, produk dan pembelian. Memerlukan PIN pejabat berwenang untuk aksi otorisasi; tidak memiliki Ringkasan, Laporan, atau Pengaturan.

Cabang: Cabang akun. Pemegang otorisasi: tidak. Edit stok awal: ya.
...
![Ops Admin — Transaksi](../fix-verification-2026-09-06/screenshots/role-ops_admin-transaksi.png)
...
![Ops Admin — Stok / Gudang](../fix-verification-2026-09-06/screenshots/role-ops_admin-gudang.png)
...
![Ops Admin — Pembelian](../fix-verification-2026-09-06/screenshots/role-ops_admin-pembelian.png)
...
![Ops Admin — Pengeluaran](../fix-verification-2026-09-06/screenshots/role-ops_admin-pengeluaran.png)
...
![Ops Admin — Membership dan deposit](../fix-verification-2026-09-06/screenshots/role-ops_admin-member.png)
