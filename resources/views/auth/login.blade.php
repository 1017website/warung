...
<head>
    ...
    <title>Masuk · POS Warung</title>
    @include('partials.static-assets')
</head>
<body>
<div class="login-page">
    <section class="login-art">
        <div class="login-logo"><span class="brand-mark"><i class="bi bi-shop"></i></span> POS Warung</div>
    ...
    <section class="login-panel">
        <form class="login-card" method="POST" action="{{ route('login.store') }}">
            ...
            <div class="field"><label>Email</label><input id="login-email" type="email" name="email" value="{{ old('email') }}" autocomplete="email" required autofocus></div>
            ...
            <button class="btn btn-primary"><i class="bi bi-arrow-right-circle"></i> Masuk ke POS Warung</button>
        </form>
    </section>
</div>
</body>
